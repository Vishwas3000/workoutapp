...
class TodayWorkoutCard: UIView {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            workoutNameLabel.leadingAnchor.constraint(equalTo: workoutIconLabel.trailingAnchor, constant: 12),
            workoutNameLabel.trailingAnchor.constraint(equalTo: containerView.trailingAnchor, constant: -20),
    ...
    private func setupAnimations() {
        ...
        startButton.addTarget(self, action: #selector(buttonTouchUp), for: [.touchUpInside, .touchUpOutside])
    }
    ...
    func configure(with workout: WorkoutDay?) {
        ...
        if let workout = workout {
            ...
            workoutIconLabel.text = workout.type.icon
            workoutNameLabel.text = workout.name
            exerciseCountLabel.text = "📋 \(workout.exercises.count) exercises • \(workout.totalSets) total sets"
            ...
            if let color = UIColor(named: workout.type.color) {
